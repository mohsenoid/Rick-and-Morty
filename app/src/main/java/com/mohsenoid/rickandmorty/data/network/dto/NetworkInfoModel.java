...
class NetworkInfoModel {
    ...
    private NetworkInfoModel(int count, int pages, String next, String prev) {
        this.count = count;
        this.pages = pages;
        this.next = next;
        this.prev = prev;
    ...
    static NetworkInfoModel fromJson(JSONObject jsonObject) throws JSONException {
        ...
        return new NetworkInfoModel(count, pages, next, prev);
    }
